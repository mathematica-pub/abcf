...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(bcfoverparRcppClean(y_, z_, w_, x_con_, x_mod_, x_con_info_list, x_mod_info_list, burn, nd, thin, ntree_mod, ntree_con, lambda, nu, con_sd, mod_sd, con_alpha, con_beta, mod_alpha, mod_beta, treef_con_name_, treef_mod_name_, status_interval, RJ, use_mscale, use_bscale, b_half_normal, randeff, batch_size, acceptance_target, trt_init, verbose, block_v_rho, block_batch_size, block_b0_b1, sigu_hyperprior, sigv_hyperprior, hardcode_sigma_u, hardcode_sigma_v, hardcode_rho, hardcode_sigma_u_val, hardcode_sigma_v_val, hardcode_rho_val, rho_beta_prior, rho_beta_a, rho_beta_b));
