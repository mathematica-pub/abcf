...
// bcfoverparRcppClean
List bcfoverparRcppClean(NumericVector y_, NumericVector z_, NumericVector w_, NumericVector x_con_, NumericVector x_mod_, List x_con_info_list, List x_mod_info_list, int burn, int nd, int thin, int ntree_mod, int ntree_con, double lambda, double nu, double con_sd, double mod_sd, double con_alpha, double con_beta, double mod_alpha, double mod_beta, CharacterVector treef_con_name_, CharacterVector treef_mod_name_, bool keep_trees, bool continuous_tree_save, int status_interval, bool use_halfnormal_scales, bool abcf, bool ibcf, int batch_size, double acceptance_target, double trt_init, int verbose, bool block_b0_b1, double sigu_hyperprior, double ate_prior_sd);
RcppExport SEXP _abcf_bcfoverparRcppClean(SEXP y_SEXP, SEXP z_SEXP, SEXP w_SEXP, SEXP x_con_SEXP, SEXP x_mod_SEXP, SEXP x_con_info_listSEXP, SEXP x_mod_info_listSEXP, SEXP burnSEXP, SEXP ndSEXP, SEXP thinSEXP, SEXP ntree_modSEXP, SEXP ntree_conSEXP, SEXP lambdaSEXP, SEXP nuSEXP, SEXP con_sdSEXP, SEXP mod_sdSEXP, SEXP con_alphaSEXP, SEXP con_betaSEXP, SEXP mod_alphaSEXP, SEXP mod_betaSEXP, SEXP treef_con_name_SEXP, SEXP treef_mod_name_SEXP, SEXP keep_treesSEXP, SEXP continuous_tree_saveSEXP, SEXP status_intervalSEXP, SEXP use_halfnormal_scalesSEXP, SEXP abcfSEXP, SEXP ibcfSEXP, SEXP batch_sizeSEXP, SEXP acceptance_targetSEXP, SEXP trt_initSEXP, SEXP verboseSEXP, SEXP block_b0_b1SEXP, SEXP sigu_hyperpriorSEXP, SEXP ate_prior_sdSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type keep_trees(keep_treesSEXP);
    Rcpp::traits::input_parameter< bool >::type continuous_tree_save(continuous_tree_saveSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_abcf_bcfoverparRcppClean", (DL_FUNC) &_abcf_bcfoverparRcppClean, 35},
    {"_rcpp_module_boot_TreeSamples", (DL_FUNC) &_rcpp_module_boot_TreeSamples, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_abcf(DllInfo *dll) {
