...
file.copy('c:/projects/bcf-sim-infra/data/sim_study_config_medicare_and_edu.xlsx',
          'data/mar-2023-uiw/sim_study_config_medicare_and_edu.xlsx',
          overwrite=TRUE)

file.copy('c:/projects/bcf-sim-infra/scripts/mar-2023-uiw/test_list.RDS',
          'data/mar-2023-uiw/test_list.RDS',
          overwrite=TRUE)

scenarios <- readRDS('data/mar-2023-uiw/test_list.RDS') %>%
  ...
  distinct %T>%
  saveRDS('data/mar-2023-uiw/_scenarios.RDS') %>%
  select(scenario, world, set)

from <- 's3://bcf-sim-study/mar-2023-uiw/1kburn-1ksim'
to <- 'C:/Projects/bcf-sim-study/Data/mar-2023-uiw/1kburn-1ksim'
...
files <- tibble(file = dir(to, pattern = '*.RDS', recursive = FALSE, full.names = TRUE)) %>%
  mutate(name = file %>% str_remove('C:/Projects/bcf-sim-study/Data/mar-2023-uiw/1kburn-1ksim/') %>% str_remove('\\.RDS'),
...
#combine_output_chunks(smalls, dir='C:/Projects/bcf-sim-study/Data/mar-2023-uiw', save_big=FALSE)
combine_output_chunks(bigs, dir='C:/Projects/bcf-sim-study/Data/mar-2023-uiw', save_big=TRUE)
