...
scenarios <- readxl::read_xlsx('data/jan-2022-runs/sim_study_config_medicare_and_edu.xlsx', sheet='scenarios') %>%
...
from <- 's3://bcf-sim-study/jan-2021-runs/4kburn-2ksim'
to <- 'C:/Projects/bcf-sim-study/Data/jan-2022-runs/4kburn-2ksim'
...
combine_output_chunks(smalls, dir='C:/Projects/bcf-sim-study/Data/jan-2022-runs', save_big=FALSE)
